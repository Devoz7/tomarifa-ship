const CarbonTrackerLogo = ({ size = 32, className = "", animate = false }) => {
  return (
    <div className={`relative ${className}`}>
      ...
      >
        ...
        {/* Continents stylisés */}
        <path
          d="M8 12c2-1 4-1 6 0s3 2 5 1c1-1 2-3 4-2"
          stroke="#10B981"
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"
        />
        <path
          d="M6 20c3-1 5 0 7-1s4-2 6-1c1 1 2 2 4 1"
          stroke="#10B981"
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"

...
const Header = () => {
  ...
  useEffect(() => {
    // Vérifier si on vient juste de se connecter via les paramètres d'URL ou sessionStorage
    const urlParams = new URLSearchParams(window.location.search);
    const hasAuthParams = urlParams.has('code') || urlParams.has('state'); // Paramètres OAuth
    const justLoggedIn = sessionStorage.getItem('justLoggedIn') === 'true';
    
    if (session && (hasAuthParams || justLoggedIn)) {
      // Affichage instantané pour une nouvelle connexion
      setShowSuccessModal(true);
      // Nettoyer les marqueurs
      sessionStorage.removeItem('justLoggedIn');
      // Nettoyer l'URL des paramètres OAuth (optionnel)
      if (hasAuthParams) {
  ...
  // Marquer quand l'utilisateur initie une connexion
            ...
            >
              ...
              <div className="h-full flex flex-col bg-white">
                ...
                <div className="bg-gradient-to-r from-violet-600 to-purple-600 p-6 text-white">
                  ...
                  {session ? (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-white/80 text-sm">{session.user.email}</div>
                      </div>
                    </div>
                  ) : (
                  ...
                  {!session && (
                    <div className="mt-4 text-center">
                      <span className="text-white/80 text-sm">No account yet? </span>
                      <button className="text-white font-medium underline hover:no-underline">Create an account</button>
                    </div>
                  )}
                </div>
                ...
                <div className="p-6 border-b border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Voyages</h3>
                  <div className="space-y-3">
                    <button className="w-full bg-gray-50 hover:bg-gray-100 rounded-xl p-4 flex items-center gap-4 transition-colors group">
                      ...
                      <div className="flex-1 text-left">
                        <div className="font-medium text-gray-800">Réserver un vol</div>
                        <div className="text-sm text-gray-500">Trouvez les meilleurs prix</div>
                      </div>
                    ...
                    <button className="w-full bg-gray-50 hover:bg-gray-100 rounded-xl p-4 flex items-center gap-4 transition-colors group">
                      ...
                      <div className="flex-1 text-left">
                        <div className="font-medium text-gray-800">Mes voyages</div>
                        <div className="text-sm text-gray-500">Gérez vos réservations</div>
                      </div>
                      <svg className="w-5 h-5 text-gray-400 group-hover:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                ...
                <div className="p-6 flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button className="bg-gray-50 hover:bg-gray-100 rounded-xl p-4 flex flex-col items-center gap-2 transition-colors group">
                      ...
                      <span className="text-sm font-medium text-gray-800">Crypto News</span>
                    </button>
                    ...
                    <button className="bg-gray-50 hover:bg-gray-100 rounded-xl p-4 flex flex-col items-center gap-2 transition-colors group">
                      ...
                      <span className="text-sm font-medium text-gray-800">Portefeuille</span>
                    </button>
                    ...
                    <button className="bg-gray-50 hover:bg-gray-100 rounded-xl p-4 flex flex-col items-center gap-2 transition-colors group">
                      ...
                      <span className="text-sm font-medium text-gray-800">Parrainage</span>
                    </button>
                    ...
                    <button className="bg-gray-50 hover:bg-gray-100 rounded-xl p-4 flex flex-col items-center gap-2 transition-colors group">
                      ...
                      <span className="text-sm font-medium text-gray-800">Aide</span>
                    </button>
                  </div>
                </div>

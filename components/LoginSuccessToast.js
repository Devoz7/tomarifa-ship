  ...
  return (
    <div className="relative bg-gradient-to-br from-violet-600 via-purple-600 to-blue-600 rounded-2xl shadow-2xl border border-white/20 backdrop-blur-sm max-w-md mx-auto">
      ...
      <div className="p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-white/70 text-sm mb-6">
            Vous êtes maintenant connecté et prêt à voyager vers de nouveaux
            horizons
          </p>
      ...
      <div className="absolute inset-0 overflow-hidden rounded-2xl">
        ...
        <div
          className="absolute top-8 right-8 w-1 h-1 bg-white/40 rounded-full animate-ping"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-6 left-6 w-1.5 h-1.5 bg-white/25 rounded-full animate-ping"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-4 right-12 w-1 h-1 bg-white/35 rounded-full animate-ping"
